"""
Django settings for meila_ops project.
...
SECRET_KEY = '%9r3zbxehp&zi4i1#ad)9n)spsbwzf-=cewsdu+b*yzs%-4u=)'
...
INSTALLED_APPS = [
    ...
    'captcha',
    'pure_pagination',
    'logic.db.meila_ops.apps.LitchiConfig',
    'apps.core.apps.CoreConfig',
    'apps.users.apps.UsersConfig',
    'apps.asset.apps.AssetConfig',
    'apps.perm.apps.PermConfig',
...
WSGI_APPLICATION = 'meila_ops.wsgi.application'
...
AUTH_USER_MODEL = 'meila_ops.User'
...
EMAIL_USE_TLS = eval('{{ EMAIL_USE_TLS }}')
